    ...
    <div className="max-w-5xl mx-auto p-8">
      ...
      {step === 'input' && (
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#E2E8F0] max-w-2xl mx-auto">
          <h2 className="font-sans font-semibold text-lg text-[#0D2535] mb-6">
          ...
          />
          {error && (
            <p className="text-[#DC2626] font-sans text-sm mb-4 bg-[#FEE2E2] p-3 rounded-lg border border-[#FCA5A5]">
              {error}
            </p>
          )}
          <button
      ...
      {step === 'archetypes' && (
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#E2E8F0]">
          <div className="flex items-center justify-between mb-6">
            <h2 className="font-sans font-semibold text-lg text-[#0D2535]">
